        ...
        <div className="max-w-sm mx-auto w-full relative z-10 bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 shadow-xl">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              className="group relative flex items-center justify-center gap-2 border border-gray-200 bg-white/50 backdrop-blur-sm rounded-lg py-2 hover:border-blue-400 hover:bg-blue-50/50 hover:shadow-md transition-all duration-300"
            >
              <FcGoogle size={16} />
